                ...
                <>
                        ...
                        <Container className="hero">
                            <Container className="hero-content">
                                ...
                                <Typography className="hero-subtitle">
                                    ...
                                    Track your daily mood, log a brief description, and access curated music to uplift
                                    your
                                    spirits.
                                </Typography>
                            ...
                            <div className="feature-row">
                                <div className="feature-left" data-aos="fade-right">
                                    ...
                                    <p>Say goodbye to the fragmentation of your thoughts and emotions!
                                        With Moodily, you&rsquo;ll have a safe space to collect the scattered pieces of
                                        your day
                                        and
                                ...
                                <div className="feature-right" data-aos="fade-left">
                                    ...
                                    <p>Our user-friendly interface makes it a breeze to log your daily emotions.
                                        Whether you&rsquo;re over the moon, feeling meh, or having a tough day, Moodily
                                        has got
                                        your
                                        back.</p>
                                </div>
                            ...
                            <div className="feature-row">
                                ...
                                <div className="feature-right" data-aos="fade-left">
                                    ...
                                    <p>Connect with like-minded Moodiliers in our supportive community. Share
                                        your journey, lend an ear, and find solace in the fact that you&rsquo;re not
                                        alone in
                                        this
                            ...
                            <div className="feature-row">
                                <div className="feature-left" data-aos="fade-right">
                                    ...
                                    <p>Define your aspirations and goals, both big and small, and track your progress
                                        with Moodily. Stay motivated and take meaningful steps towards achieving the
                                        life you
                                        desire.</p>
                                </div>
                                <div className="feature-right" data-aos="fade-left">
                                    ...
                                    <p>Express yourself freely through our digital journal. Write down your thoughts,
                                        reflections, and dreams. Let Moodily be your trusted companion in your personal
                                        growth
                                        journey.</p>
                                </div>
                            </div>
                            <div className="feature-row">
                                <div className="feature-left" data-aos="fade-right">
                                    ...
                                    <p>Begin each day with positivity by setting daily affirmations and intentions.
                                        Moodily helps you start your day with a smile and a positive mindset, ready to
                                        conquer
                                        any challenges.</p>
                                </div>
                                <div className="feature-right" data-aos="fade-left">
                                    ...
                                    <p>Celebrate your victories, no matter how small, and see how far you&rsquo;ve come.
                                        Moodily&rsquo;s tracking features allow you to visualize your personal growth
                                        journey
                                        and
                    ...
                    <Container className="how-it-works" data-aos="zoom-in" data-aos-once="true">
                        ...
                        <div className="section section-list" data-aos="zoom-in" data-aos-once="true">
                            ...
                            <li>
                                Check-In: Share your mood for the day. Use emojis, words, or even doodles; it&rsquo;s
                                all about
                                expressing yourself!
                            </li>
                            <li>
                                Track Progress: Watch your mood history unfold. Gain insights into patterns and
                                triggers.
                            </li>
                            <li>
                                Celebrate the Wins: Celebrate those days when your mood is on point, and get support on
                                the
                                tougher ones.
                            </li>
                            <li>
                            ...
                            <p className="section-text">
                                Ready to start your mood-tracking adventure and bring some order to life&rsquo;s
                                delightful
                                chaos?
                                Join Moodily today and let&rsquo;s create a brighter, more balanced you, one mood at a
                                time. 🌞✨
                            </p>
                            <p className="section-text">
